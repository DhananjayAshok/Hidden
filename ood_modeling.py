...
task_datasets = {"unanswerable": ["qnota", "selfaware", "known_unknown"], "toxicity_avoidance": ["real_toxicity_prompts", "toxic_chat"]}
...
def main(task, prediction_dir, model_save_name, random_sample_train_per, random_sample_test_per, random_seed, model_kind):
